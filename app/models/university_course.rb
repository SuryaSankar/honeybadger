class UniversityCourse < ActiveRecord::Base
	belongs_to :university, touch: true	#EC321 belongs to NIT Trichy
	belongs_to :course, touch: true	#EC321 belongs to Analog electronic circuits
	has_many :qpapers	
	has_many :program_university_courses, dependent: :destroy	#EC321 has 1.EC321 in B-Tech ECE, 2. EC321 in B-Tech EEE, 3. EC321 in B-Tech ICE
